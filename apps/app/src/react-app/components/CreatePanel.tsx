  ...
  const onNoteSubmit = useCallback(
    async (e: FormEvent<HTMLFormElement>) => {
      ...
      try {
        ...
        // window.location.origin keeps the fragment on the same host that
        // just produced the key — using siteUrl would cross origins in local
        // dev and silently strip the fragment on paste.
