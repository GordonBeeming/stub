...
import { base64UrlDecodeToBytes } from '../lib/base64url';
import { KEY_BYTES, decryptCiphertext } from '../lib/notes-crypto';
...
export function NoteViewer() {
  const [, params] = useRoute<{ id: string }>('/n/:id');
  ...
  async function handleCopy() {
    ...
    try {
      ...
      // policy). Plaintext stays on-screen for manual copy.
    }
  }

  return (
    <section style={{ maxWidth: 640 }}>
      {state.kind === 'loading' ? <h2 style={stateTitle}>Decrypting…</h2> : null}
